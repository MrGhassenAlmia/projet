 ...
 <!-- Main Header -->
    <header class="main-header header-style-one">
                ...
                <div class="inner-container">
                    <div class="left-column">
                        <ul class="social-icon">
                            ...
                            <li><a target="blank" href="<?php echo $setting['twitter']; ?>"><i class="fab fa-instagram"></i></a></li>
        ...
        <div class="header-upper">
            <div class="auto-container">
                <div class="inner-container">
                    <!--Logo-->
                    <div class="logo-box">
                        <div class="logo"><a href="index.php"><img src="assets/images/logo1.png" width="120px" height="120px" alt=""></a></div>
                    </div>
                    <div class="right-column">
                        <!--Nav Box-->
                        <div class="nav-outer">
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.php"><img src="assets/images/logo1.png" width="200px" height="150px" alt="" title=""></a></div>
