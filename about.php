...
<?php include "header.php"; ?>
    ...
    <!-- Page Title -->
    <section class="page-title" style="background-image: url(assets/images/main-slider/img2.jpg);">
        ...
        <div class="top-content">
            <div class="auto-container">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="image mb-30"><img src="assets/images/main-slider/img4.jpeg"  alt=""></div>
                    </div>
                </div>
            </div>
        </div>
   ...
   <!-- <section class="whychooseus-section-four" style="background-image: url(assets/images/background/bg-23.jpg);">
    ...
    <section class="statement-section pt-0">
        <div class="auto-container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="image"><img src="assets/images/main-slider/img5.jpg" alt=""></div>
                </div>
                <div class="col-lg-6">
                    <div class="content">  
