...
<div class="page-wrapper">
   ...
   <?php include "header.php"; ?>
    ...
    <!-- Page Title -->
    <section class="page-title" style="background-image: url(assets/images/background/img3.jpg);">
                    ...
                    <div class="news-block-four">
                        <div class="inner-box">
                            <div class="image">
                                ...
                                <div class="overlay-two"><a href="admin/images/blog/<?php echo $row['img']; ?>" alt="" class="lightbox-image" data-fancybox="gallery"><span class="flaticon-zoom-in"></span></a></div>
                            </div>
